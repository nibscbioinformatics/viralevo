...
source("snpeff_script.R")


# strip path and prefix with current workdir

vcf <- readVcf(basename(vcffile), genome = genome)
...
cov <- DataTrack(range = basename(bamfile), genome = gen, type = "l",
